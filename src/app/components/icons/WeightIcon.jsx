export default function WeightIcon({ width = "64px", height = "64px", className = "" }) {
  return (
    <svg 
      width={width} 
      height={height} 
