export default function BellIcon({ width = "64px", height = "64px", className = "" }) {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M7.5 19C8.15503 20.7478 9.92246 22 12 22C12.2445 22 12.4847 21.9827 12.7192 21.9492M16.5 19C16.2329 19.7126 15.781 20.3428 15.1985 20.8393" stroke="currentColor" strokeWidth="0.8399999999999999" strokeLinecap="round"></path>
      </g>
    </svg>
  );
} 