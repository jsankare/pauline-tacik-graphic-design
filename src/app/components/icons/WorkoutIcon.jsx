export default function WorkoutIcon({ width = "20px", height = "20px", className = "" }) {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <circle cx="18.5" cy="4.5" r="2.5" stroke="currentColor" strokeWidth="0.792"></circle>
        ...
        <path d="M9 17L8.74064 17.3112C7.32089 19.0149 5.21773 20 3 20" stroke="currentColor" strokeWidth="0.792" strokeLinecap="round"></path>
        <path d="M16 12C17.3131 12.3283 18.6869 12.3283 20 12" stroke="currentColor" strokeWidth="0.792" strokeLinecap="round"></path>
      </g>
    </svg>
  );
} 