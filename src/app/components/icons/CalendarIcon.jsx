export default function CalendarIcon({ width = "20px", height = "20px", className = "" }) {
  return (
    <svg 
      width={width} 
      height={height} 
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M7 4V2.5" stroke="currentColor" strokeWidth="0.8399999999999999" strokeLinecap="round"></path>
        <path d="M17 4V2.5" stroke="currentColor" strokeWidth="0.8399999999999999" strokeLinecap="round"></path>
        <path d="M21.5 9H16.625H10.75M2 9H5.875" stroke="currentColor" strokeWidth="0.95" strokeLinecap="round"></path>
