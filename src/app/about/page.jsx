...
import { H1, Button } from "../components/ui/ui";
            ...
            <div className="max-w-6xl mx-auto px-6 py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
                    ...
                    <div className="relative group">
                        <div className="relative w-full h-96 lg:h-[500px] overflow-hidden transition-transform duration-300 group-hover:scale-105">
                            <Image
                                src={Illustration}
